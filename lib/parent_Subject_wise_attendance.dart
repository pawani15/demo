...
class ParentSubjectWiseAttendance extends StatefulWidget {
  final String studentname,id;
  ParentSubjectWiseAttendance({this.studentname, this.id});
  int  currentIndex = 0;
  num present,
      absent,
      sickleave,
  ...
  @override
  State<StatefulWidget> createState() => new _ParentSubjectWiseAttendancePageState();
}

class _ParentSubjectWiseAttendancePageState extends State<ParentSubjectWiseAttendance> {
...
//          "api_parent/subjecwise_attendance_report_view/" + widget.id;
       var url = await Constants().Clienturl() + Constants.Parent_subjectwise_Attendance+widget.id;
      Map<String, String> body = new Map();
      body['student_id'] =  widget.id;
