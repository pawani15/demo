...
class ParentHomework extends StatefulWidget {
  ...
  ParentHomework({this.studentname,this.studentid});
  @override
  State<StatefulWidget> createState() => new _ParentHomeworkPageState();
}

class _ParentHomeworkPageState extends State<ParentHomework> with SingleTickerProviderStateMixin{
  ...
  Future<Null> LoadHomework() async {
    ...
    var url = await Constants().Clienturl() + Constants.Homework_Parent+widget.studentid;
...
//              ),
  ...
  Future<Null> Download(String filename) async {
    ...
    var url = await Constants().Clienturl() +  "api_parents/force_download/home_work/" + filename;
...
class Homeworkdetails {
  String  description, id, hwtitle,assigndt,subname,date,filename,fileurl,sno,duedt,assignby,file;
  Homeworkdetails({this.sno, this.description, this.id, this.hwtitle,this.assigndt,this.duedt,this.file,this.date,this.subname,this.filename,this.fileurl,this.assignby});
...
//      id: json[''].toString() ,
      ...
      filename: json['download'].toString(),
