...
class GroupchatPage extends StatefulWidget {
  ...
  GroupchatPage({this.messageDetails});

  @override
  State<StatefulWidget> createState() => new _GroupchatPageState();
}
...
class _GroupchatPageState extends State<GroupchatPage> with SingleTickerProviderStateMixin{
  ...
  Future<Null> LoadGroupmessages(String d) async {
    ...
    var url = await Constants().Clienturl() +Constants.Load_Groupuserschat+widget.messageDetails['group_message_thread_code'];
  ...
  Future<Null> Sendmessage() async {
    ...
    var url = await Constants().Clienturl() + Constants.Send_replyGroupchat+widget.messageDetails['group_message_thread_code'];
    Map<String, String> body = new Map();
    body['teacher_id' ] = id;
