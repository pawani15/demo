...
import '../parent_homework.dart';
import 'academic_sylabus_student.dart';
...
class StudentAttendance extends StatefulWidget {
  ...
  @override
  State<StatefulWidget> createState() => new _StudentAttendancePageState();
}

class _StudentAttendancePageState extends State<StudentAttendance> {
  //num halfLeave;
  @override
  void initState() {
    super.initState();
  ...
  Future<Null> GetRunningyear() async {
    if (widget.fromdate != null && widget.todate != null) {
      ...
      var url = await Constants().Clienturl() +
          Constants.Load_StudentsAttendance;
...
//            print ("dfasd"+  month2.length.toString());
 ...
 Future<Null>_print( )async
  {
    String fileurl = await Constants().Clienturl() +
        "api_students/download_academic_syllabus/";
  //  String url = homeworkdetails.fileurl;
  //  String body = "academic_syllabus_code=" +Uri.encodeComponent(syllabusdetails.fileurl);
    String root = (await getExternalStorageDirectory()).path;
    String filePath = "$root/Edecofy" +
        new DateTime.now().millisecondsSinceEpoch.toString() + ".pdf";
    print("FilePath:--" + filePath);
    DownloadUtil.download(fileurl, filePath, context: context);
  }
