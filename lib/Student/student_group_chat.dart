...
class StudentGroupchatPage extends StatefulWidget {
  final Map messageDetails;
  StudentGroupchatPage({this.messageDetails});
  @override
  State<StatefulWidget> createState() => new _StudentGroupchatPageState();
}

class _StudentGroupchatPageState extends State<StudentGroupchatPage> with SingleTickerProviderStateMixin{
  String message="";
  bool _loading = false;
  ...
  Future<Null> LoadGroupmessages(String d) async {
    ...
    var url = await Constants().Clienturl() +Constants.Student_Load_Groupuserschat+widget.messageDetails['group_message_thread_code'];
  ...
  Future<Null> Sendmessage() async {
    ...
    var url = await Constants().Clienturl() + Constants.Student_Send_replyGroupchat+widget.messageDetails['group_message_thread_code'];
    Map<String, String> body = new Map();
    body['login_user_id'] = id;
