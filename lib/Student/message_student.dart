...
import 'student_private_message.dart';

//import 'const.dart';
//import 'dashboard.dart';
//import 'search.dart';

class StudentMessagesystem extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => new _StudentMessagesystemState();
}

class _StudentMessagesystemState extends State<StudentMessagesystem> with SingleTickerProviderStateMixin {
  ...
  Future<Null> LoadReceptents() async {
    ...
    var url = await Constants().Clienturl() + Constants.Student_Load_Receipents;
  ...
  Future<Null> Sendmessage() async {
    ...
    var url = await Constants().Clienturl() + Constants.Student_send_newmessage;
    Map<String, String> body = new Map();
  ...
  _Fileypedialog(String action,StudentMessageDetails studentMessage) async{
