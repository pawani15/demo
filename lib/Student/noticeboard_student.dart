...
class StudentNoticeboard extends StatefulWidget {
  ...
  @override
  State<StatefulWidget> createState() => new _StudentNoticeboardPageState();
}

class _StudentNoticeboardPageState extends State<StudentNoticeboard>
{
                    ...
                    child:new Column(
                      children: <Widget>[
                        ...
                        new Row(
                          ...
                          children: <Widget>[
                            Expanded(
                              child: new Text("Title:",style: TextStyle(color: Colors.black,fontWeight: FontWeight.bold)),flex: 3,
                            ),
                            Expanded(
                        ...
                        new Row(
                          ...
                          children: <Widget>[
                            Expanded(
                              child: new Text("Notice:",style: TextStyle(color: Colors.black,fontWeight: FontWeight.bold)),flex: 3,
                            ),
                            Expanded(
...
//              ),
          ...
          new Card(
            elevation: 5.0,
            margin: new EdgeInsets.only(left: 10,right: 10,bottom: 0,top: 100),
                  ...
                  children: <Widget>[
                    ...
                    new Padding(padding: new EdgeInsets.all(5),
                        child: new Row(
                          ...
                          mainAxisAlignment: MainAxisAlignment.center,
                          children: <Widget>[
                            new Expanded(child: new Padding(padding: EdgeInsets.symmetric(horizontal: 3,vertical: 6),child:new Text("Sl.No",style: TextStyle(color: Colors.grey,fontSize: 12,fontWeight: FontWeight.bold),textAlign: TextAlign.center)),flex: 1,),
                        ...
                        children: <Widget>[
                          new Padding(padding: new EdgeInsets.all(5),
                              child: new Row(
                                ...
                                mainAxisAlignment: MainAxisAlignment.center,
                                children: <Widget>[
                                  new Expanded(child: new Padding(padding: EdgeInsets.symmetric(horizontal: 3,vertical: 6),child:new Text("${_searchResult[index].sno}",style: TextStyle(color: Colors.black,fontSize: 11),textAlign: TextAlign.center)),flex: 1,),
                                  new Expanded(child: new Padding(padding: EdgeInsets.symmetric(horizontal: 3,vertical: 6),child:new Text(_searchResult[index].title,style: TextStyle(color: Colors.black,fontSize: 11),textAlign: TextAlign.center)),flex: 2,),
                                  new Expanded(child: new Padding(padding: EdgeInsets.symmetric(horizontal: 3,vertical: 6),child:new Text(_searchResult[index].notice,style: TextStyle(color: Colors.black,fontSize: 11),textAlign: TextAlign.center,maxLines: 2,),),flex: 3,),
                                  new Expanded(child: new Padding(padding: EdgeInsets.symmetric(horizontal: 3,vertical: 6),child:new Text(_searchResult[index].date,style: TextStyle(color: Colors.black,fontSize: 11),textAlign: TextAlign.center)),flex: 2,),
                                  new Expanded(child: new Padding(padding: EdgeInsets.symmetric(horizontal: 3,vertical: 6),
                                    ...
                                    children: <Widget>[
                                      ...
                                      new Icon(Icons.remove_red_eye,color: Colors.white,size: 10,)
                                    ],
                                  ),padding: new EdgeInsets.all(5),
                                    color: Theme.of(context).primaryColor,
                                  ),
