...
class StudentManageProfilePage extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => new _StudentManageProfilePageState();
}

class _StudentManageProfilePageState extends State<StudentManageProfilePage> {
  bool notification = false,locationtracking = false;
  String student= "",email='';
  bool _loading = false;
  TextEditingController stucont= new TextEditingController();
  ...
  Future<Null> LoadProfile() async {
    ...
    var url = await Constants().Clienturl() + Constants.Student_Manage_Profile;
    Map<String, String> body = new Map();
    body['student_id'] = id;
    body['type_view'] = "view_profile";
    ...
    http.post(url,
      ...
      if (response.statusCode == 200) {
        ...
        if (responseJson['status'].toString() == "true") {
          ...
          try {
            stucont.text = responseJson['result']['view_data'][0]['name'];
            emailcont.text = responseJson['result']['view_data'][0]['email'];
            print(stucont.text);
...
//      url = await Constants().Clienturl() + Constants.Update_profile_Teacher +
//          await Constants().Userid();
//    }
    body['type_view'] = "change_password";
    body['student_id'] = id;
