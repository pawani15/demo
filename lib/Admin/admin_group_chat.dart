...
class AdminGroupchatPage extends StatefulWidget {
  final Map messageDetails;
  AdminGroupchatPage({this.messageDetails});
  @override
  State<StatefulWidget> createState() => new _AdminGroupchatPageState();
}

class _AdminGroupchatPageState extends State<AdminGroupchatPage> with SingleTickerProviderStateMixin{
  String message="";
  bool _loading = false;
  ...
  Future<Null> LoadGroupmessages(String d) async {
    ...
    var url = await Constants().Clienturl() +Constants.Admin_Load_Groupuserschat+widget.messageDetails['group_message_thread_code'];
  ...
  Future<Null> Sendmessage() async {
    ...
    var url = await Constants().Clienturl() + Constants.Admin_Send_replyGroupchat+widget.messageDetails['group_message_thread_code'];
    Map<String, String> body = new Map();
    body['admin_id'] = id;
