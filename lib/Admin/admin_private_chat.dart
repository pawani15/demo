import 'package:Edecofy/Admin/admin_private_message.dart';
...
class AdminPrivatechatPage extends StatefulWidget {
  final AdminMessageDetails messageDetails;
  AdminPrivatechatPage({this.messageDetails});

  @override
  State<StatefulWidget> createState() => new _AdminPrivatechatPageState();
}
...
//here//
    ...
    var url = await Constants().Clienturl() + Constants.Admin_Send_Privatechat+widget.messageDetails.messagethread;
    Map<String, String> body = new Map();
    body['admin_id'] = id;
