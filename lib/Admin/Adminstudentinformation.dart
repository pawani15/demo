...
class _AddlasssPagePageState extends State<AddStudentsPage> with SingleTickerProviderStateMixin{
    ...
    http.post(url,
      ...
      if (response.statusCode == 200) {
        ...
        if (responseJson['status'].toString() == "true") {
          ...
          studentcode.text =responseJson['result'][''].toString();
  ...
  _navigatetogender2(BuildContext context) async {
    List<String> Genderlist= new List();
    Genderlist.add("Male");
    Genderlist.add("Female");
    String result = await Constants().Selectiondialog(context, "Gender", Genderlist);
                      ...
                      new Expanded(child:new Container(
                          ...
                          child: new InkWell(
                              onTap: () {
                                ...
                                if(p_password.text == null){
                                  Constants().ShowAlertDialog(context, "Please enter the password");
                                  return;
                                }
    ...
    http.post(url,
      ...
      if (response.statusCode == 200) {
        ...
        if(responseJson['status'].toString() == "true"){
          ...
          Constants().ShowAlertDialog(context, "Parent not added succesfully");
        }
      }
      else {
        Navigator.of(context).pop();
