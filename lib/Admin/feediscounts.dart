...
class FeediscountssPage extends StatefulWidget {

  @override
  State<StatefulWidget> createState() => new _FeediscountssPageState();
}

class _FeediscountssPageState extends State<FeediscountssPage> {
  bool _loading = false,show=false;
  TextEditingController controller = new TextEditingController();
  List feediscountslist = new List();
    ...
    http.get(url,
      ...
      if (response.statusCode == 200) {
        ...
        if (responseJson['status'].toString() == "true") {
          print("response json ${responseJson}");
          try {
            feediscountslist = responseJson['result']['std_all'];
          }catch(e){
            feediscountslist = new List();
          }
        }
        setState(() {
          _loading = false;
  ...
  TextEditingController discountname= new TextEditingController(),discountamount = new TextEditingController(),
      description = new TextEditingController(),discountcode = new TextEditingController();
  AddsFeediscountsdialog(String action) async {
    String titlename = "Add Fees Discount";
    if(action == "new") {
      discountname.text = '';
      discountamount.text = '';
      discountcode.text = '';
        ...
        children: <Widget>[
          new Container(
            ...
            child: new Container(
              ...
              child: new Text("Fees Discount",style: TextStyle(color: Colors.white,fontSize: 16.0,fontWeight: FontWeight.bold),textAlign: TextAlign.center,),
            ),
          ),
                  ...
                  child: new ListView(
                    children: <Widget>[
                      new Container(
                          ...
                          children: <Widget>[
                            new Expanded(child: new Padding(child: new Text("Fees Discount List",style: TextStyle(color: Theme.of(context).primaryColor,fontWeight: FontWeight.bold),),padding: EdgeInsets.only(left: 10),),flex: 5,),
                            new Expanded(child:  new Container(
