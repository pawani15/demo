...
class FeestypesPage extends StatefulWidget {

  @override
  State<StatefulWidget> createState() => new _FeestypesPageState();
}

class _FeestypesPageState extends State<FeestypesPage> {
  bool _loading = false,show=false;
  TextEditingController controller = new TextEditingController();
  List feetypeslist = new List();
    ...
    http.get(url,
      ...
      if (response.statusCode == 200) {
        ...
        if (responseJson['status'].toString() == "true") {
          print("response json ${responseJson}");
          try {
            feetypeslist = responseJson['result']['std_all'];
          }catch(e){
            feetypeslist = new List();
          }
        }
        setState(() {
          _loading = false;
  ...
  TextEditingController name= new TextEditingController(),amount = new TextEditingController(),
      description = new TextEditingController();

  AddsFeetypesdialog(String action) async {
    String titlename = "Add Fees Type";
    if(action == "new") {
      name.text = '';
      amount.text = '';
      description.text='';
        ...
        children: <Widget>[
          new Container(
            ...
            child: new Container(
              ...
              child: new Text("Fees Type",style: TextStyle(color: Colors.white,fontSize: 16.0,fontWeight: FontWeight.bold),textAlign: TextAlign.center,),
            ),
          ),
                  ...
                  child: new ListView(
                    children: <Widget>[
                      new Container(
                          ...
                          children: <Widget>[
                            new Expanded(child: new Padding(child: new Text("Fees Type",style: TextStyle(color: Theme.of(context).primaryColor,fontWeight: FontWeight.bold),),padding: EdgeInsets.only(left: 10),),flex: 5,),
                            new Expanded(child:  new Container(
