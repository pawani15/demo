...
class Teacher_ManageProfilePage extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => new _Teacher_ManageProfilePageState();
}

class _Teacher_ManageProfilePageState extends State<Teacher_ManageProfilePage> {
  bool notification = false,locationtracking = false;
  String teacher= "",email='';
  bool _loading = false;
  TextEditingController teachcont= new TextEditingController();
  ...
  Future<Null> LoadProfile() async {
    ...
    var url = await Constants().Clienturl() + Constants.Manage_Profile_Teacher+id;
    ...
    http.post(url,
      ...
      if (response.statusCode == 200) {
        ...
        if (responseJson['status'].toString() == "true") {
          ...
          try {
            teachcont.text = responseJson['result'][0]['name'];
  ...
  Future<Null> Updateemail() async {
    ...
    var url = await Constants().Clienturl() + Constants.Update_profile_Teacher;
    Map<String, String> body = new Map();
    body['teacher_id'] = id;
    body['email'] = emailcont.text;
    body['name'] = teachcont.text;
                    ...
                    children: <Widget>[
                      new Expanded(child: new Container(
                          ...
                          child: new InkWell(
                              onTap: () {
                                setState(() {
                                  currentpassword.text='';newpassword.text='';confirmnewpassword.text='';teachcont.text="";emailcont.text="";
                                });
                              },
                              child: new Container(
