...
class BookdetailsPageTeacher extends StatefulWidget {

  @override
  State<StatefulWidget> createState() => new _BookdetailsTeacherPageState();
}

class _BookdetailsTeacherPageState extends State<BookdetailsPageTeacher> with SingleTickerProviderStateMixin{
  ...
  Future<Null> Loadbooks() async {
    ...
    var url = await Constants().Clienturl() + Constants.Load_Books_Teacher;
...
//              ),
          ...
          new Container(
              ...
              child : new Stack(
                children: <Widget>[
                        ...
                        child: new ListView(
                          children: <Widget>[
                            new Container(
                              ...
                              child: new Text("Books List",style: TextStyle(color: Theme.of(context).primaryColor,fontWeight: FontWeight.bold),),
                            ),
                            ...
                            _Bookdetails.length == 0 ? new Container(child: new Center(child: new Text("No Records found",style: new TextStyle(fontSize: 16.0,color: Colors.red))))
                              ...
                              child: DataTable(
                                ...
                                columns: [
                                  ...
                                  DataColumn(
                                    label: Text("Price",style: TextStyle(color: Theme.of(context).primaryColor, fontSize: 15.0),),
                                  ),
                                  DataColumn(
                  ...
                  Constants.logintype == "student" ? new Align(
                      ...
                      child: new InkWell(child:new Container(
                        ...
                        child: new Icon(FontAwesomeIcons.book,color: Colors.white,size: 20,),
                      ),onTap: (){
  ...
  requestnewbookdialog(String status,) async {
                    ...
                    children: <Widget>[
                      ...
                      new Expanded(child:new Container(
                          ...
                          child: new InkWell(
                              onTap: () {
                                if(book == ""){
                                  Constants().ShowAlertDialog(context, "Please enter book");
                                  return;
                                }
                                if(startdate ==null){
                                  Constants().ShowAlertDialog(context, "Please select issue start date");
                                  return;
                                }
                                if(enddate ==null){
                                  Constants().ShowAlertDialog(context, "Please select issue end date");
                                  return;
                                }
                              },
                              child: new Container(
                                  ...
                                  child: new Row(
                                    ...
                                    children: <Widget>[
                                      ...
                                      new Padding(padding: EdgeInsets.only(left: 5.0),child: Text("Submit",style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold,fontSize: 11),),)
                                    ],
                                  )))),flex: 1,),
                    ],
                  ),
  ...
  onSearchTextChanged(String text) async {
    ...
    _Bookdetails.forEach((vehicleDetail) {
      if (vehicleDetail.author.toLowerCase().contains(text.toLowerCase()) || vehicleDetail.title.toLowerCase().contains(text.toLowerCase()))
...
class Bookdetails {
  ...
  Bookdetails({this.title, this.author, this.description, this.price,this.classname,this.bookid,this.filedownload,this.filename});
